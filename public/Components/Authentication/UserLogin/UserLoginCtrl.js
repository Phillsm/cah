...
angular.module('myAppRename.UserLoginCtrl', ['ngRoute'])
    .config(['$routeProvider', function($routeProvider) {
        $routeProvider.when('/uc', {
        });
    }])
    .controller('UserLoginCtrl', function ($scope, $modal, $log,$http) {
        ...
        $scope.open = function (size) {
            ...
            var modalInstance = $modal.open({
                templateUrl: '/cah/public/Components/Authentication/UserLoginCtrl/UserLoginCtrl-ModalDialog.html',
...
//inside dialog
angular.module('myAppRename.UserLoginCtrl').controller('ModalInstanceCtrl', function ($scope,$http, $modalInstance, items) {
    ...
    $scope.ok = function () {
        ...
        $http.post(window.conf.UserLogin.Logon, {Username: $scope.Username  }).
